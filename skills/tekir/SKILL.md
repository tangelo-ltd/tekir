---
name: tekir
description: Build TEKIR-compliant API responses with structured metadata for AI agents
user-invocable: true
---
...
TEKIR = Transparent Endpoint Knowledge for Intelligent Reasoning. It is a standard for enriching HTTP API responses with structured metadata so that AI agents can understand, navigate, and act on API responses without out-of-band documentation.
